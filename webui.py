...
def create_ui(config, theme_name="Ocean"):
    ...
    with gr.Blocks(
            title="Mando AI Agent Llama3", theme=theme_map[theme_name], css=css
    ) as demo:
        with gr.Row():
            gr.Markdown(
                """
                # 🌐 Control your browser with Mando AI Agent 🤖 assistance
                ### powered by browseruse framework
                """,
...
def main():
    parser = argparse.ArgumentParser(description="Gradio UI for Mando Browser Agent")
    parser.add_argument("--ip", type=str, default="127.0.0.1", help="IP address to bind to")
    parser.add_argument("--port", type=int, default=8000, help="Port to listen on")
    parser.add_argument("--theme", type=str, default="Glass", choices=theme_map.keys(), help="Theme to use for the UI")
